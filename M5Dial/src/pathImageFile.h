...
// メニュー画面の画像配置
String existTagMenuImage[3] = {PATH_MENU_GREEN_BELL, PATH_MENU_GREEN_SETTING,
                               PATH_MENU_GREEN_ADD};
String notExistTagMenuImage[3] = {PATH_MENU_RED_BELL, PATH_MENU_RED_SETTING,
                                  PATH_MENU_RED_ADD};
int menuImageLength = sizeof(existTagMenuImage) / sizeof(existTagMenuImage[0]);
int menuImageIndex = 0;

// 設定画面の画像配置
String settingImage[4][3] = {
    {PATH_SETTING_TOP_OFF_OFF, PATH_SETTING_RIGHT_OFF_OFF,
     PATH_SETTING_LEFT_OFF_OFF},
    {PATH_SETTING_TOP_ON_OFF, PATH_SETTING_RIGHT_ON_OFF,
     PATH_SETTING_LEFT_ON_OFF},
    {PATH_SETTING_TOP_OFF_ON, PATH_SETTING_RIGHT_OFF_ON,
     PATH_SETTING_LEFT_OFF_ON},
    {PATH_SETTING_TOP_ON_ON, PATH_SETTING_RIGHT_ON_ON,
     PATH_SETTING_LEFT_ON_ON}};
int settingImageLength = sizeof(settingImage[0]) / sizeof(settingImage[0][0]);
